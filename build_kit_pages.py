...
KITS = {
 "dino-6-8": ("🦖","Dino Escape: Operation Rexy","6-8","3-8","30-45","19",
 ...
 "space-5-6": ("🚀","Space Station Escape","5-6","3-8","25-40","19",
 ...
 "spy-7-9": ("🕵️","Spy HQ Lockdown","7-9","3-8","35-50","19",
 ...
 "pirate-6-8": ("🏴‍☠️","Pirate Treasure Escape","6-8","3-8","30-45","19",
 ...
 "unicorn-5-7": ("🦄","Rainbow Kingdom Escape","5-7","3-8","25-40","19",
 ...
 "superhero-6-9": ("🦸","Superhero Academy Escape","6-9","3-8","30-45","19",
 ...
 "princess-4-6": ("👑","Royal Castle Escape","4-6","3-8","20-35","19",
 ...
 "mermaid-5-7": ("🧜‍♀️","Mermaid Lagoon Escape","5-7","3-8","25-40","19",
 ...
 "jungle-safari-6-8": ("🐒","Jungle Safari Rescue Escape","6-8","3-8","30-45","19",
 ...
 "ninja-7-9": ("🥷","Ninja Dojo Escape","7-9","3-8","30-45","19",
 ...
 "halloween-6-9": ("🎃","Monster Mansion Escape","6-9","3-8","30-45","19",
 ...
 "christmas-5-8": ("🎄","Santa's Workshop Escape","5-8","3-8","30-45","19",
 ...
 "easter-4-7": ("🐰","Easter Bunny's Egg Hunt Escape","4-7","3-8","20-35","19",
